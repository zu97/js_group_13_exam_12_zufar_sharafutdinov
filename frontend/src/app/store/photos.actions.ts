...
import { AddError, AddPhotoData, Photo, PhotoError } from '../models/photo.model';
...
export const fetchPhotosFailure = createAction('[Photos] Fetch Failure', props<{ error: null | PhotoError }>());
...
export const removePhotoFailure = createAction('[Photos] Remove Failure', props<{ error: null | PhotoError }>());
